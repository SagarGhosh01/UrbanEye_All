  ...
  const PUNJAB_ROAD_SEGMENTS = [
    {
      ...
      name: 'NH-44 Phagwara-Mehtan Expressway Corridor',
      roadClass: 'trunk',
      cityTag: 'kapurthala',
      districtId: kapurthala.id,
      coordinates: JSON.stringify([
    ...
    {
      osmWayId: 'kap-way-sh24',
      name: 'Kapurthala - Phagwara Highway SH-24',
      roadClass: 'primary',
      cityTag: 'kapurthala',
      districtId: kapurthala.id,
      coordinates: JSON.stringify([
    ...
    },
    {
      ...
      name: 'Kapurthala City Center Circular Corridor',
      roadClass: 'secondary',
      cityTag: 'kapurthala',
      districtId: kapurthala.id,
      coordinates: JSON.stringify([
