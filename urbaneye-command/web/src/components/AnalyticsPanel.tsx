...
export const AnalyticsPanel: React.FC<AnalyticsPanelProps> = ({ stats, districtName, showReports = false }) => {
  ...
  return (
    <div className="mb-6 space-y-6 text-[#172B3A] font-sans">
      
      {/* 1. Official Report Generation Cards Section */}
      {showReports && (
        <div className="bg-white rounded-xl border border-[#D8E0E8] p-5 shadow-sm space-y-4">
      ...
      {/* 2. Professional Restrained Blue Analytics Dashboard Stat Cards */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        
        <div className="bg-white p-4 rounded-xl border border-[#D8E0E8] shadow-sm">
